...
<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title">
            <a class="btn bg-dark btn-sm" href="/laboratories/new">Nuevo Laboratorio</a>
        </h3>
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <table id="adminsTable" class="table table-bordered table-striped tableLaboratories">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Codigo</th>
...
<script>
    window.document.title = "Laboratorios"
</script>