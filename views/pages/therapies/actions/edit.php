            ...
            <div class="col-md-8 offset-md-2">
                ...
                <div class="form-group mt-2 row">
                    ...
                    <div class="col-lg-2 form-group">
                        ...
                        <input type="text" class="form-control" pattern="[-\\(\\)\\=\\%\\&\\$\\;\\_\\*\\/\\#\\?\\¿\\!\\¡\\:\\,\\.\\0-9a-zA-ZñÑáéíóúÁÉÍÓÚ ]{1,}" onchange="validateRepeat(event,'regex','therapies','code_therapy')" name="codigo" value="<?php echo $therapy->code_therapy ?>" required readonly>
                    ...
                    <div class="col-lg-8 form-group">
                        ...
                        <input type="text" class="form-control" pattern="[-\\(\\)\\=\\%\\&\\$\\;\\_\\*\\/\\#\\?\\¿\\!\\¡\\:\\,\\.\\0-9a-zA-ZñÑáéíóúÁÉÍÓÚ ]{1,}" onchange="validateRepeat(event,'regex','therapies','name_therapy')" name="nombre" value="<?php echo $therapy->name_therapy ?>" required>
